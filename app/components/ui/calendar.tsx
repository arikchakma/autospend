...
function Calendar(props: CalendarProps) {
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'group/calendar bg-white p-3 [--cell-size:--spacing(8)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent',
      ...
      classNames={{
        ...
        dropdown_root: cn(
          'relative has-focus:border-zinc-900 border border-zinc-200 has-focus:ring-zinc-900/50 has-focus:ring-[3px] rounded-md',
